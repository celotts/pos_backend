package com.celotts.pos.infrastructure.security.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/auth/**").permitAll() // Permitir acceso público a endpoints de autenticación
                .requestMatchers("/actuator/**").permitAll() // Permitir acceso público a Actuator
                .anyRequest().authenticated() // Todas las demás peticiones requieren autenticación
            );
        // Aquí se añadirán los filtros JWT más adelante
        return http.build();
    }
